...
val md_theme_light_primary = Color(0xFF1959C1)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_secondary = Color(0xffecf5fc)
...
val md_theme_dark_secondary = Color(0xff092730)
